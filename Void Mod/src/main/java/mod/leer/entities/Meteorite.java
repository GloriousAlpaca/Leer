...
import mod.leer.audio.MovingSoundMeteorite;
...
/*Code der Fireball Klasse
 * -------------------------------------------------------------------------------------------------------------------------------------------
 */
	    public Meteorite(World worldIn)
	    {
	        super(worldIn);
	    ...
	    public Meteorite(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ)
	    {
	        super(worldIn);
	        this.setSize(1.0F, 1.0F);
	        ...
	        if(!this.world.isRemote) 
		        Minecraft.getMinecraft().getSoundHandler().playSound(new MovingSoundMeteorite(this));
	    }

	    public Meteorite(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ)
	    {
	        super(worldIn);
